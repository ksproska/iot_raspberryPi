...
if __name__ == '__main__':
    ...
    a = SensorHandler(oh, lambda: 1, (30, 3), ((30, 0), (96, 20)), 0.1, 'Temp: ', 'C')
    b = SensorHandler(oh, lambda: 1, (30, 19), ((30, 15), (96, 35)), 0.1, 'Hum:  ', '%')
    c = SensorHandler(oh, lambda: 1, (30, 35), ((30, 30), (96, 50)), 0.1, 'Alt:     ', 'm')
    d = SensorHandler(oh, lambda: 1, (30, 50), ((30, 45), (96, 65)), 1, 'Press:', 'hPa')
    a.print()
    b.print()
    c.print()
    d.print()
